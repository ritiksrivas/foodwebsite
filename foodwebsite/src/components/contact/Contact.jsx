...
// import {faPaperPlane,faGithub,faTwitter,faInstagram,faLocationPin,faPhone,faEnvelope} from '@fortawesome/free-solid-svg-icons';
import "./Contact.css";
              ...
              <div class="screen-body-item">
                <div class="app-form">
                  <div class="app-form-group">
                    <input type="text" class="app-form-control" placeholder="NAME" value="" required />
                  </div>
                  <div class="app-form-group">
